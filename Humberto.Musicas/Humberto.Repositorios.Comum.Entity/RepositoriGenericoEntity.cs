...
namespace Humberto.Repositorios.Comum.Entity
{
    public class RepositoriGenericoEntity<TEntidade, TChave> : IRepositorioGenerico<TEntidade, TChave>
        where TEntidade : class
    {
        protected DbContext _contexto;

        public RepositoriGenericoEntity(DbContext contexto)
        {
            _contexto = contexto;
        }
